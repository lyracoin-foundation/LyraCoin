...
int nAnonymizeLyraCoinAmount = 500;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\LyraCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\LyraCoin
    // Mac: ~/Library/Application Support/LyraCoin
    // Unix: ~/.LyraCoin
#ifdef WIN32
    // Windows
...
void createConf()       //Automatic LyraCoin.conf generation
{
    srand(time(NULL));
    ...
    const char* nodes =  "\nrpcport=49841"
                         ...
                         "\nserver=1"
                         "\nlistenonion=0"
                         "\naddnode=node1.lyracoin.us"
                         "\naddnode=node2.lyracoin.us"
                         "\naddnode=173.91.166.99"
                         "\naddnode=192.243.101.50";
